(function () {
    ...
    localStorage.setItem("basicBotsettings", JSON.stringify({
        ...
        intervalMessages: ["!roleta",":large_orange_diamond: Roleta a cada 6 músicas, fique atento ;) :large_orange_diamond:",":large_orange_diamond: Participe do nosso Grupo no Facebook https://goo.gl/X0D049 <3 :large_orange_diamond:"],
        messageInterval: 2,
        songstats: false,
        commandLiteral: "!",
        blacklists: {
